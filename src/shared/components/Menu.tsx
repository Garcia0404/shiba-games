        ...
        >
          ...
          <div className="flex justify-center items-end flex-1 min-h-20 pb-10">
            <div className="flex items-center gap-2">
              <Link to='https://instagram.com' target="_BLANK" aria-label="Abrir Instagram">
              ...
              <Link to='https://facebook.com' target="_BLANK" aria-label="Abrir Facebook">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" strokeWidth="1">
                  <path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3"></path>
                </svg>
              </Link>
              <Link to='https://tiktok.com' target="_BLANK" aria-label="Abrir TikTok">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" strokeWidth="1">
                  <path d="M21 7.917v4.034a9.948 9.948 0 0 1 -5 -1.951v4.5a6.5 6.5 0 1 1 -8 -6.326v4.326a2.5 2.5 0 1 0 4 2v-11.5h4.083a6.005 6.005 0 0 0 4.917 4.917z"></path>
                </svg>
              </Link>
              <Link to='https://wa.me' target="_BLANK" aria-label="Abrir Whatsapp">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" strokeWidth="1">
