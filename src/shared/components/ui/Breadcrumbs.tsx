      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div className="flex items-center">
            ...
            <Link to="/games" className="ms-1 text-sm font-medium md:ms-2 text-white/70 hover:text-white">Juegos</Link>
          </div>
        </li>
        <li aria-current="page">
          <div className="flex items-center">
            ...
            <div className="ms-1 text-sm font-medium text-white/80 md:ms-2 line-clamp-1">{title}</div>
          </div>
        </li>
      </ol>
    </nav>
